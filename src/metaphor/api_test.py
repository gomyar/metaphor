...
#        self.schema.insert_resource('grant', {'type': 'create', 'url': '/users/%s/references' % user_id}, 'grants', 'group', group_id_1)
    ...
    def test_grants(self):
        ...
        self.assertTrue(Api._has_grants('/something/me', '/something/me', ['/something']))
        # url path and resource path doesn't start with grant url
        self.assertFalse(Api._has_grants('/something/me', '/something/me', ['/something/me/you']))
        # canonical url doesn't start with grant url
        self.assertFalse(Api._has_grants('/else/me', '/else/me', ['/something/me']))
        # canonical url starts with grant url
        self.assertTrue(Api._has_grants('/else/me', '/something/me', ['/something/me']))

        # wildcards in url
        self.assertTrue(Api._has_grants('/else/me', '/something/ID12345/me', ['/something/*/me']))
        self.assertTrue(Api._has_grants('/else/me', '/something/ID12345', ['/something/*']))

        # filters in url (still only uses the canonical url)
        self.assertTrue(Api._has_grants('/else[name="bob"]/me', '/something/ID12345/me', ['/something/*/me']))
        self.assertTrue(Api._has_grants('/else[name="bob"&&age<24]/me', '/something/ID12345', ['/something/*']))

        # combination (still only uses the canonical url)
        self.assertTrue(Api._has_grants('/else[name="bob"]/me/ID12345', '/something/ID12345/me/ID98765', ['/something/*/me/*']))


        # path url starts with ego and starts with grant url (canonical url different)
        self.assertTrue(Api._has_grants('/ego/me', '/something/me', ['/ego/me']))
        self.assertFalse(Api._has_grants('/ego/me', '/ego', ['/ego']))

        self.assertTrue(Api._has_grants('/ego/me/ID12345/inner', '/something/inner/ID98765', ['/ego/me/*/inner']))
        self.assertTrue(Api._has_grants('/ego/me/inner', '/something/inner/ID98765', ['/ego/me/inner']))

        # filters in ego url
        self.assertTrue(Api._has_grants('/ego/me[age=12&&name="sales"]/inner', '/something/inners/ID98765', ['/ego/me/inner']))

        # can mix and match ids and wildcards
        self.assertTrue(Api._has_grants('/something/ID12345/me/ID98765/inner', '/something/ID12345/me/ID98765/inner', ['/something/ID12345/me/*/inner']))
        self.assertTrue(Api._has_grants('/ego/somethings/ID12345/me/ID98765/inner', '/something/ID12345/me/ID98765/inner', ['/ego/somethings/ID12345/me/*/inner']))

        # nested ids
        self.assertTrue(Api._has_grants('/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', '/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', ['/groups']))
        self.assertTrue(Api._has_grants('/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', '/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', ['/groups/*/grants']))
        self.assertTrue(Api._has_grants('/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', '/groups/ID621d36160452da3eb71d178b/grants/ID621d36160452da3eb71d178c', ['/']))
