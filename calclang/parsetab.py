...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement_expr','lang.py',61),
  ('expression -> NAME LPAREN expression RPAREN','expression',4,'p_expression_function','lang.py',65),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','lang.py',69),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','lang.py',70),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','lang.py',71),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','lang.py',72),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','lang.py',79),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','lang.py',87),
  ('expression -> NUMBER','expression',1,'p_expression_number','lang.py',91),
  ('expression -> NAME','expression',1,'p_expression_name','lang.py',95),
]
